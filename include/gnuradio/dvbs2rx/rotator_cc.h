...
#ifndef INCLUDED_DVBS2RX_ROTATOR_CC_H
#define INCLUDED_DVBS2RX_ROTATOR_CC_H
 ...
 */
class DVBS2RX_API rotator_cc : virtual public sync_block
{
public:
...
#endif /* INCLUDED_DVBS2RX_ROTATOR_CC_H */
