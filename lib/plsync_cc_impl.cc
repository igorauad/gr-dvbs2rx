      ...
      fine_foffset(0.0)
{
    ...
    gr_complex conj_mod_sof[SOF_LEN] = {
        (+0.7071068 - 0.7071068i), (+0.7071068 + 0.7071068i), (-0.7071068 + 0.7071068i),
        (-0.7071068 - 0.7071068i), (+0.7071068 - 0.7071068i), (-0.7071068 - 0.7071068i),
        (-0.7071068 + 0.7071068i), (+0.7071068 + 0.7071068i), (+0.7071068 - 0.7071068i),
        (+0.7071068 + 0.7071068i), (+0.7071068 - 0.7071068i), (-0.7071068 - 0.7071068i),
        (-0.7071068 + 0.7071068i), (-0.7071068 - 0.7071068i), (-0.7071068 + 0.7071068i),
...
pl_descrambler::pl_descrambler(int gold_code) : gold_code(gold_code)
{
    build_symbol_scrambler_table();
}

int pl_descrambler::parity_chk(long a, long b)
{
...
void pl_descrambler::step(const gr_complex& in, gr_complex& out, int i)
{
    switch (Rn[i]) {
    case 0:
        out = in;
