...
struct Forney {
    typedef typename GF::ValueType ValueType;
    typedef typename GF::IndexType IndexType;
    static int compute_evaluator(ValueType* syndromes,
                                 ValueType* locator,
                                 int locator_degree,
                                 ValueType* evaluator)
    {
    ...
    static void compute_magnitudes(ValueType* locator,
                                   IndexType* locations,
                                   int count,
                                   ValueType* evaluator,
    ...
    static int algorithm(ValueType* syndromes,
                         ValueType* locator,
                         IndexType* locations,
                         int count,
                         ValueType* evaluator,
...
struct ReedSolomonErrorCorrection {
    ...
    int operator()(ValueType* syndromes,
                   IndexType* locations,
                   ValueType* magnitudes,
