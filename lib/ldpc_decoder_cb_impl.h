...
private:
    ...
    unsigned int nldpc;       /**< Codeword length in bits */
    unsigned int nldpc_bytes; /**< Codeword length in bytes */
    unsigned int signal_constellation;
    unsigned int code_rate;
    unsigned int kldpc;       /**< Message length in bits */
    unsigned int kldpc_bytes; /**< Message length in bytes */
    unsigned int q_val;
